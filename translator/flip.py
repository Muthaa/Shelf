...
#icon
image_icon = PhotoImage(file="Google_Translate_logo_(old).png")
...
label1=Label(root, text="English", font= "segoe 30 bold", bg="white", width=18,
				bd=5, relief=GROOVE)
...
label2=Label(root, text="English", font= "segoe 30 bold", bg="white", width=18,
				bd=5, relief=GROOVE)
...
translate = Button(root, text = "Translate", font = "Roboto 15 bold italic",
					...
					bg= 'teal', fg = "white", command = translate_now)
